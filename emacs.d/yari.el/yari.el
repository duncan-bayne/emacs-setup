...
;; DB: This is a slightly modified version of yari.el; I've submitted a PR to
;; the maintainer with the changes, and will switch to the package version if
;; / when those changes are mainlined and released.
